...
module.exports = (app) => {
  ...
  route.post(
    '/piggybank',
    authenticationMiddleware,
    celebrate(usersValidator.Createuserpiggybank),
    usersControllers.createuserpiggybank
  );

  route.get(
    '/piggybank/ktp',
    authenticationMiddleware,
    usersControllers.getktpforpiggybank
  );
  route.put(
    '/piggybank/ktp/:id',
    authenticationMiddleware,
    celebrate(usersValidator.updatektppiggybank),
    usersControllers.updatektppiggybank
  );
  route.delete(
    '/piggybank/:id',
    authenticationMiddleware,
    usersControllers.deleteuserpiggybank
  );
};
